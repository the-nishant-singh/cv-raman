...
function addingbook(){
    const book = document.getElementById('new-book-name').value
    if(!book) alert('Please enter a book name')
    else{
        console.log(book)
        const newChild = document.createElement("li")
        newChild.innerHTML = '<span class="name">' + book + '</span><span class="delete">delete</span>'
        document.getElementById('book-container').appendChild(newChild)
    }
}